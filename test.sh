...
# 构建订阅链接
echo "========== 生成订阅链接 =========="
subscribeclash="https://suc-jp.bihai.site/sub?target=clash&url=$encoded_combined_urls&insert=false&config=https%3A%2F%2Fraw.githubusercontent.com%2Fzsokami%2FACL4SSR%2Frefs%2Fheads%2Fmain%2FACL4SSR_Online_Full_Mannix_No_DNS_Leak.ini&exclude=聖荷西|西班牙|->&filename=GitHub-GetNode&emoji=true&sort=true&udp=true"
subscribeV2ray="https://suc-jp.bihai.site/sub?target=v2ray&url=$encoded_combined_urls&insert=false&config=https%3A%2F%2Fraw.githubusercontent.com%2Fzsokami%2FACL4SSR%2Frefs%2Fheads%2Fmain%2FACL4SSR_Online_Full_Mannix_No_DNS_Leak.ini&exclude=聖荷西|西班牙|->&filename=GitHub-GetNode&emoji=true&sort=true&udp=true"
